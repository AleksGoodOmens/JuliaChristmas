...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  banner.addEventListener('mouseenter', (e) => {
    if (!isPaused) bannerText.style.animationPlayState = 'paused';
  });

  banner.addEventListener('mouseleave', (e) => {
    if (!isPaused) bannerText.style.animationPlayState = 'running';
  });
  new Countdown('.countdown', '2027-01-01T00:00:00').init();
